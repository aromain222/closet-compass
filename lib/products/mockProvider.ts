...
export const MOCK_PRODUCTS: ProductResult[] = [
  ...
  product({
    id: "mock-cotton-linen-pull-on-trouser",
    title: "Pull-On Linen-Cotton Wide-Leg Trouser",
    brand: "Everyday Studio",
    retailer: "Northline",
    price: 68,
    originalPrice: 88,
    currency: "USD",
    productUrl: "https://example.com/products/cotton-linen-pull-on-trouser",
    imageUrl: "https://images.unsplash.com/photo-1509631179647-0177331693ae",
    category: "pants",
    colors: ["natural", "black", "terracotta"],
    sizes: ["XS", "S", "M", "L", "XL"],
    description: "Pull-on wide-leg trouser with elastic waist and a breathable linen-cotton blend.",
    listedMaterials: ["55% cotton, 42% linen, 3% elastane"],
    inferredMaterials: ["linen cotton blend"],
    materialConfidence: 0.88,
    softnessScore: 70,
    stretchScore: 34,
    ...
    reviewSummary: "Very similar drape to pricier linen trousers; pull-on waist is more forgiving."
  }),
  product({
    id: "mock-viscose-wide-leg-pant",
    title: "Fluid Wide-Leg Trouser",
    brand: "City Muse",
    retailer: "FastFinds",
    price: 44,
    currency: "USD",
    productUrl: "https://example.com/products/viscose-wide-leg-pant",
    imageUrl: "https://images.unsplash.com/photo-1506629082955-511b1aa562c8",
    category: "pants",
    colors: ["black", "sand", "olive"],
    sizes: ["XS", "S", "M", "L", "XL", "XXL"],
    description: "Flowy wide-leg trouser with a smooth viscose drape. Woven, not knit.",
    listedMaterials: ["100% viscose"],
    inferredMaterials: ["viscose woven"],
    materialConfidence: 0.82,
    softnessScore: 76,
    stretchScore: 12,
    ...
    reviewSummary: "Great silhouette and price, but less breathable than linen and wrinkles easily."
  }),
  product({
  ...
  product({
    id: "mock-cotton-poplin-shirt-budget",
    title: "Classic Cotton Button-Down Shirt",
    brand: "Oak & Thread",
    retailer: "Cedar & Co",
    price: 46,
    currency: "USD",
    productUrl: "https://example.com/products/cotton-button-down-budget",
    imageUrl: "https://images.unsplash.com/photo-1604695573706-db9a5f4a5dd4",
    category: "shirt",
    colors: ["white", "light blue"],
    sizes: ["XS", "S", "M", "L", "XL"],
    description: "Relaxed poplin button-down with a clean finish. Slightly lighter weight than structured poplin.",
    listedMaterials: ["100% cotton"],
    inferredMaterials: ["cotton poplin"],
    materialConfidence: 0.84,
    softnessScore: 62,
    stretchScore: 4,
    ...
    durabilityScore: 72,
    careInstructions: ["machine wash warm", "tumble dry low"],
    reviewSummary: "Clean, structured look at a lower price point; fabric is thinner than higher-end poplin."
  }),
  product({
